...
router.post('/', function(req, res) {
    ...
    <style>
      ...
      <h3>THÔNG TIN ĐƠN HÀNG Cakestore</h3>
      <ul>  
      ...
      `;
        ...
        var dem_l = 0;
        var dem_m = 0;
        for (let i of(req.body.imgCake).split("next")) {
            dem_j = 0;
            for (let j of(req.body.nameCake).split("next")) {
                dem_k = 0;
  ...
  <h3>THÔNG TIN THANH TOÁN Cakestore</h3>
...
router.post('/PayPal', function(req, res) {
    ...
    <style>
      ...
      <h3>INFORMATION ORDER CAKESTORE</h3>
      <ul>  
